...
export default {
    content: [
        ...
        // Kozmetik sinif adlari PHP'de tanimli (magaza urunleri, oyuncu karti) —
        // taranmazsa Tailwind bu siniflari hic uretmez, urunler gorunmez kalir.
        './app/Support/CimShop.php',
